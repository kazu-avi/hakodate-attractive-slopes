    ...
    public function run()
    {
        ...
        DB::table('categories')->insert([
            [
                ...
                'address' => '函館市入舟町',
                'description' => '函館の坂で最も西側に位置する。回遊してくる魚群を見るのに便利な場所だったことから名づけられた。天候がよければ、青い海と駒ヶ岳を望むことができる穏やかな通りである。',
            ],
            [
                'name' => '船見坂',
                'img' => 'https://hakodate-slopes.s3-ap-northeast-1.amazonaws.com/categories/2.jpeg',
                'address' => '函館市船見町',
                'description' => '「船見町」誕生時に現在の名前になった。港を行き来する船がよく見えることが由来である。坂の途中には、その特徴的な姿から映画ロケで使用されることが多い大正湯がある。',
            ],
            [
                'name' => '千歳坂',
